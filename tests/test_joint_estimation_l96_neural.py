...
from oceanml3d.legacy.models.direct_unet import JointDirectUNet, ParamHeadUNet
from oceanml3d.legacy.models.vanilla_cfm import JointCFM, JointCFMCoupled, ParamFlowUNet
...
def test_model_factory_joint_l96(l96_joint_cfg):
    ...
    def build(name):
        with initialize(version_base="1.3", config_path="../config/legacy"):
...
def test_param_flow_cnn_attn_pool_shape(l96_joint_dataset):
    from oceanml3d.legacy.models.vanilla_cfm import ParamFlowCNN
...
def test_param_head_cnn_attn_pool_shape(l96_joint_dataset):
    from oceanml3d.legacy.models.direct_unet import ParamHeadCNN
