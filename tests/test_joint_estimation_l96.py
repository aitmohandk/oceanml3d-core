...
from oceanml3d.legacy.evaluation.metrics import param_rmse
...
class TestJointStrong4DVarL96:
    ...
    def test_batched_method_estimates_params(self, l96_ctx, device):
        from oceanml3d.legacy.evaluation.baselines import Strong4DVar
    ...
    def test_evaluate_baseline_routes_batched(self, l96_ctx, device):
        ...
        from oceanml3d.legacy.evaluation.run_l96 import evaluate_baseline, make_obs_j_indices
    ...
    def test_nan_window_skipped(self, l96_ctx, device, monkeypatch):
        from oceanml3d.legacy.data.lorenz96 import Lorenz96Config
        from oceanml3d.legacy.evaluation.baselines import BaselineResult
        from oceanml3d.legacy.evaluation.run_l96 import evaluate_baseline, make_obs_j_indices
