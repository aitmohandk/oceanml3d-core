...
def model_factory(cfg: DictConfig, device: torch.device):
    ...
    if model_type == "tweedie":
        ...
        from oceanml3d.legacy.models.param_head import StateParamModel
        ...
        from oceanml3d.legacy.models.vanilla_cfm import PredictStateCFM
        ...
        from oceanml3d.legacy.models.vanilla_cfm import TweedieCFM
        ...
        from oceanml3d.legacy.models.fourdvarnet import FourDVarNetPredictStateCFM
