...
from oceanml3d.legacy.models.unet import AttentionPool1D, ConvBlock, Down, SinusoidalEmbedding, UNet1D, Up
...
class TweedieCFM(nn.Module):
    ...
    def __init__(
        ...
        from oceanml3d.legacy.models.residual import MeanEstimatorCell
