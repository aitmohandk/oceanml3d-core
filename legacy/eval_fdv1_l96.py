...
from oceanml3d.legacy.evaluation.estimate_metrics import evaluate_estimates, save_estimates
from oceanml3d.legacy.evaluation.neural_inference import load_model, prepare_dataset, run_inference
...
def main():
    ...
    if norm_stats is not None:
        ...
        from oceanml3d.legacy.data.normalization import denormalize
